 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||E(e)&&"[object Symbol]"==s(e)};/** Used as references for various `Number` constants. */var h=0/0,w=/^[-+]0x[0-9a-f]+$/i,L=/^0b[01]+$/i,T=/^0o[0-7]+$/i,k=parseInt;function I(e,t){localStorage.setItem(e,JSON.stringify(t))}let N={formElem:document.querySelector(".feedback-form")};N.formElem.addEventListener("input",function(e){let t=e.target.name,n=e.target.value;I(t,n)}),N.formElem.addEventListener("submit",function(e){e.preventDefault();let t=N.formElem.elements.email.value,n=N.formElem.elements.message.value;I("feedback-form-state",{email:t,message:n}),console.log({email:t,message:n}),e.target.reset();// localStorage.removeItem('email');
...
let e=function(e){let t=localStorage.getItem(e);try{return JSON.parse(t)}catch(e){return t}}("feedback-form-state");e&&(N.formElem.elements.email.value=email||"email",N.formElem.elements.message.value=message||"input text")})}();//# sourceMappingURL=03-feedback.bda55162.js.map

//# sourceMappingURL=03-feedback.bda55162.js.map

 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||E(e)&&"[object Symbol]"==m(e)};/** Used as references for various `Number` constants. */var h=0/0,w=/^[-+]0x[0-9a-f]+$/i,k=/^0b[01]+$/i,I=/^0o[0-7]+$/i,L=parseInt;function T(e,t){localStorage.setItem(e,JSON.stringify(t))}let N={formElem:document.querySelector(".feedback-form")};N.formElem.addEventListener("input",function(e){let t=e.target.name,n=e.target.value;T(t,n)}),N.formElem.addEventListener("submit",function(e){e.preventDefault();let t=N.formElem.elements.email.value,n=N.formElem.elements.message.value;if(t&&n){let o={email:t,message:n};console.log(o),e.target.reset(),T("feedback-form-state",o),localStorage.removeItem("feedback-form-state")}else alert("Please fill in all fields before submitting.")}),document.addEventListener("DOMContentLoaded",function(){let e=function(e){let t=localStorage.getItem(e);try{return JSON.parse(t)}catch(e){return t}}("feedback-form-state");e&&(N.formElem.elements.email.value=email||"email",N.formElem.elements.message.value=message||"input text")})}();//# sourceMappingURL=03-feedback.a46023f2.js.map

//# sourceMappingURL=03-feedback.a46023f2.js.map

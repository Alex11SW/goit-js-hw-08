 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||E(e)&&"[object Symbol]"==u(e)};/** Used as references for various `Number` constants. */var h=0/0,k=/^[-+]0x[0-9a-f]+$/i,w=/^0b[01]+$/i,L=/^0o[0-7]+$/i,T=parseInt;function I(e,t){localStorage.setItem(e,JSON.stringify(t))}function N(e){let t=localStorage.getItem(e);try{return JSON.parse(t)}catch(e){return t}}let $={formElem:document.querySelector(".feedback-form")};$.formElem.addEventListener("input",function(e){// const email = refs.formElem.elements.email.value;
...
//     message
// };
let t=N("feedback-form-state")||{};"email"===e.target.name?(t.email=e.target.value,t.message=""):"message"===e.target.name&&(t.message=e.target.value,t.email=""),I("feedback-form-state",t)}),$.formElem.addEventListener("submit",function(e){e.preventDefault();let t=$.formElem.elements.email.value,n=$.formElem.elements.message.value;t&&n?(console.log({email:t,message:n}),e.target.reset(),I("feedback-form-state",{})):alert("Please fill in all fields before submitting.")}),document.addEventListener("DOMContentLoaded",function(){let e=N("feedback-form-state")||{};$.formElem.elements.email.value=e.email||"",$.formElem.elements.message.value=e.message||""})}();//# sourceMappingURL=03-feedback.22920854.js.map

//# sourceMappingURL=03-feedback.22920854.js.map

 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||h(e)&&"[object Symbol]"==d(e)};/** Used as references for various `Number` constants. */var E=0/0,w=/^[-+]0x[0-9a-f]+$/i,T=/^0b[01]+$/i,I=/^0o[0-7]+$/i,L=parseInt;function N(e){let t=localStorage.getItem(e);try{return JSON.parse(t)}catch(e){return t}}let $={formElem:document.querySelector(".feedback-form")};$.formElem.addEventListener("input",function(e){let t=e.target.name,n=e.target.value;localStorage.setItem(t,JSON.stringify(n))}),document.addEventListener("DOMContentLoaded",function(){let e=N("email"),t=N("message");console.log($.formElem.elements),$.formElem.elements.email.value=e,$.formElem.elements.message.value=t})}();//# sourceMappingURL=03-feedback.10e7b50f.js.map

//# sourceMappingURL=03-feedback.10e7b50f.js.map
